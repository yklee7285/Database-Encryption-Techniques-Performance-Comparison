...
# Connection parameters for Windows PostgreSQL (connection parameters may differ) 
conn_params_windows = {
...
# Connection parameters for WSL PostgreSQL (connection parameters may differ) 
conn_params_wsl = {
    'dbname': 'postgres',
    'user': 'postgres',
    'password': 'postgrepw',  
